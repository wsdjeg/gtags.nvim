...
A lightweight Neovim plugin that integrates gtags with Neovim.

[![GitHub License](https://img.shields.io/github/license/wsdjeg/gtags.nvim)](LICENSE)
[![GitHub Issues or Pull Requests](https://img.shields.io/github/issues/wsdjeg/gtags.nvim)](https://github.com/wsdjeg/gtags.nvim/issues)
[![GitHub commit activity](https://img.shields.io/github/commit-activity/m/wsdjeg/gtags.nvim)](https://github.com/wsdjeg/gtags.nvim/commits/master/)
[![GitHub Release](https://img.shields.io/github/v/release/wsdjeg/gtags.nvim)](https://github.com/wsdjeg/gtags.nvim/releases)
[![luarocks](https://img.shields.io/luarocks/v/wsdjeg/gtags.nvim)](https://luarocks.org/modules/wsdjeg/gtags.nvim)

## Introduction

The gtags.nvim integrates the [GNU GLOBAL](http://www.gnu.org/software/global/) source code tag
system with Neovim.

## Installation

gtags.nvim works with all major Neovim plugin managers.
